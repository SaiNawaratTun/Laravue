...
const deleteEmployee = (id,name) =>{
    ...
    alerta.fire({
        ...
        confirmButtonText:'<i class="fa-solid fa-chick"></i> Yes,delete',
        cancelButtonText:'<i class="fa-solid fa-chick"></i> Cancle'
    }).then((result) =>{
...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="py-12">
            ...
            <div class="bg-white grid v-screen place-items-center pt-2">
        ...
        <Modal :show="modal" @close="closeModal">
            ...
            <div class="p-3">
                ...
                v-model="form.department_id" type="text" class="mt-1 block w-3/4"></SelectInput>
